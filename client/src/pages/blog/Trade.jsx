...
import { 
  Globe, ArrowLeftRight, TrendingUp, Ship, 
  ChevronRight, Calendar, ArrowRight, 
  BarChart3, Landmark, Truck
} from "lucide-react";
...
export default function Trade() {
  const articles = [
    {
      title: "Trade Infrastructure & Strategic Market Access",
      slug: "trade-infrastructure-and-strategic-market-access",
      date: "November 3, 2025",
      desc: "Kenya has made notable strides in securing access to global markets through multiple trade agreements, covering representing nearly 50% of targeted markets.",
      icon: <Landmark className="text-bizBlue dark:text-bizYellow" />
    },
    {
      title: "Cross-Border & Regional Trade Dynamics",
      slug: "cross-border-and-regional-trade-dynamics",
      date: "November 3, 2025",
      desc: "An analysis of the mixed outcomes in regional trade performance within the East African Community during the first quarter of 2025.",
      icon: <Truck className="text-bizBlue dark:text-bizYellow" />
    },
    {
      title: "Export Growth & Trade Deficit Trends",
      slug: "export-growth-and-trade-deficit-trends-in-kenya",
      date: "November 3, 2025",
      desc: "Kenya’s export earnings reached KSh 1.11 trillion in 2024. Explore the 10.4% growth trends and current trade balance insights.",
      icon: <Ship className="text-bizBlue dark:text-bizYellow" />
    }
  ];
    ...
    <div className="pt-0 transition-colors duration-300 bg-white dark:bg-bizDark min-h-screen text-bizBlue">
      ...
      <section className="relative min-h-[90vh] md:h-[70vh] flex items-center bg-bizYellow overflow-hidden">
        ...
        <div className="absolute inset-0 z-0 opacity-10 pointer-events-none">
            <img 
              src="https://bizlinkads.co.ke/wp-content/themes/wordpressbizlinkchild/assets/images/landing/hero-trade.jpg" 
              alt=""
        ...
        <div className="max-w-7xl mx-auto px-6 grid grid-cols-1 lg:grid-cols-2 gap-12 items-center relative z-10 py-12">
          <div className="text-left">
            <div className="inline-flex items-center gap-2 bg-bizRed text-white px-4 py-1 rounded mb-6 text-xs font-black uppercase tracking-widest animate-pulse">
              <Globe size={14} /> Global Logistics
            </div>
            ...
            <p className="text-xl md:text-2xl font-bold max-w-xl mb-8 leading-tight">
              Expand your reach with strategic market access data and regional commerce solutions.
            </p>
            <div className="flex gap-4">
                <Link to="/contact-us-2" className="bg-bizBlue text-white px-10 py-4 rounded-full font-black uppercase hover:bg-bizRed transition-all shadow-xl flex items-center gap-2 group">
                  Connect with Experts <ChevronRight size={20} className="group-hover:translate-x-1 transition-transform" />
                </Link>
            </div>
          </div>
          ...
          <div className="hidden lg:block relative">
             ...
             <div className="relative z-10 overflow-hidden rounded-[40px] border-8 border-white shadow-2xl transition-transform hover:scale-[1.02] duration-500">
                <img 
                  src="https://bizlinkads.co.ke/wp-content/themes/wordpressbizlinkchild/assets/images/landing/hero-trade.jpg" 
                  alt="International Shipping & Trade"
  ...
  <div className="flex flex-col lg:flex-row justify-between lg:items-end mb-12 sm:mb-16 lg:mb-20 gap-8">
    ...
    <div className="max-w-xl">
      ...
      ">
        Market <br className="hidden sm:block" /> Access
      </h2>
    ...
    ">
      Insights on import/export trends, international market dynamics, and local commerce strategies.
    </p>
