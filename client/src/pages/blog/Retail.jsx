...
import { 
  ShoppingBag, Store, Smartphone, Users, 
...
export default function Retail() {
  const articles = [
    {
      title: "Understanding Kenyan Consumer Trends",
      slug: "understanding-kenyan-consumer-trends-what-drives-retail-choices-today",
      date: "October 31, 2025",
      desc: "Kenyan consumers have become increasingly informed, price-sensitive, and value-driven. Discover what drives retail choices in the modern market.",
      icon: <Users className="text-bizBlue dark:text-bizYellow" />
    },
    {
      title: "Digital Retail Transformation",
      slug: "digital-retail-transformation-how-technology-is-redefining-shopping-in-kenya",
      date: "October 31, 2025",
      desc: "How mobile money and digital innovation are transforming the shopping experience from traditional storefronts to digital carts.",
      icon: <Smartphone className="text-bizBlue dark:text-bizYellow" />
    },
    {
      title: "The Evolution of Kenya’s Retail Industry",
      slug: "the-evolution-of-kenyas-retail-industry-from-open-markets-to-modern-malls",
      date: "October 31, 2025",
      desc: "The remarkable transformation of the retail sector, evolving from traditional open-air markets to a landscape of modern, diverse malls.",
      icon: <Store className="text-bizBlue dark:text-bizYellow" />
    }
  ];
    ...
    <div className="pt-0 transition-colors duration-300 bg-white dark:bg-bizDark min-h-screen text-bizBlue">
      ...
      <section className="relative min-h-[90vh] md:h-[70vh] flex items-center bg-bizYellow overflow-hidden">
        ...
        <div className="absolute inset-0 z-0 opacity-10 pointer-events-none">
            <img 
              src="https://bizlinkads.co.ke/wp-content/themes/wordpressbizlinkchild/assets/images/landing/hero-retail.jpg" 
              alt=""
        ...
        <div className="max-w-7xl mx-auto px-6 grid grid-cols-1 lg:grid-cols-2 gap-12 items-center relative z-10 py-12">
          <div className="text-left">
            <div className="inline-flex items-center gap-2 bg-bizRed text-white px-4 py-1 rounded mb-6 text-xs font-black uppercase tracking-widest animate-pulse">
              <TrendingUp size={14} /> Market Evolution
            </div>
            ...
            <p className="text-xl md:text-2xl font-bold max-w-xl mb-8 leading-tight">
              Boost sales with innovative retail marketing strategies and data-driven customer engagement.
            </p>
  ...
  <div className="flex flex-col lg:flex-row justify-between lg:items-end mb-12 sm:mb-16 lg:mb-20 gap-8">
    ...
    <div className="max-w-xl">
      ...
      ">
        Consumer <br className="hidden sm:block" /> Reports
      </h2>
    ...
    ">
      Explore trends in e-commerce, customer behavior, and growth strategies for the Kenyan retail sector.
    </p>
