...
import { 
  Banknote, Globe, Cpu, ChevronRight, 
...
export default function Finance() {
  const articles = [
    {
      title: "Banking in Kenya: Resilience and Change",
      slug: "banking-in-kenya-resilience-change-and-what-businesses-must-know",
      date: "October 24, 2025",
      desc: "Analyzing how the banking sector navigates economic headwinds while remaining a cornerstone of the economy.",
      icon: <Banknote className="text-bizBlue dark:text-bizYellow" />
    },
    {
      title: "Embedded Finance: Africa’s Next Frontier",
      slug: "embedded-finance-africas-next-frontier-kenya-leading-the-way",
      date: "October 24, 2025",
      desc: "How digital innovation and shifting consumer expectations are driving the rapid evolution of financial services.",
      icon: <Cpu className="text-bizBlue dark:text-bizYellow" />
    },
    {
      title: "The Global Finance Sector: Adapting to Change",
      slug: "the-global-finance-sector-adapting-to-change-and-powering-the-future",
      date: "June 28, 2025",
      desc: "The finance sector as the engine behind business growth, government policy, and infrastructure development.",
      icon: <Globe className="text-bizBlue dark:text-bizYellow" />
    }
  ];

  return (
    <div className="pt-20 transition-colors duration-300 bg-white dark:bg-bizDark min-h-screen">
      
      {/* --- HERO SECTION (DOMINANT YELLOW) --- */}
      <section className="relative min-h-[60vh] md:h-[70vh] flex items-center bg-bizYellow overflow-hidden text-bizBlue">
        {/* Subtle background image overlay for texture */}
        <div className="absolute inset-0 z-0 opacity-10 pointer-events-none">
            <img 
              src="https://bizlinkads.co.ke/wp-content/themes/wordpressbizlinkchild/assets/images/landing/hero-finance.jpg" 
              alt=""
        ...
        <div className="max-w-7xl mx-auto px-6 grid grid-cols-1 lg:grid-cols-2 gap-12 items-center relative z-10 py-12">
          <div className="text-left">
            <div className="inline-flex items-center gap-2 bg-bizRed text-white px-4 py-1 rounded mb-6 text-xs font-black uppercase tracking-widest animate-pulse">
              <ShieldCheck size={14} /> Market Resilience
            </div>
            ...
            <p className="text-xl md:text-2xl font-bold max-w-xl mb-8 leading-tight">
              Strategic financial services marketing and expert industry analysis for the Kenyan market.
            </p>
        ...
        <div className="max-w-7xl mx-auto">
          <div className="flex flex-col md:flex-row justify-between items-end mb-16 gap-6">
            ...
            <p className="text-gray-600 dark:text-gray-400 font-bold max-w-md text-lg">
              Banking trends, investment opportunities, and fintech innovations shaping Kenya's economy.
            </p>
          </div>
